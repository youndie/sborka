...
import ru.workinprogress.sborka.internal.fixture.JoinsFixtureUsed
import java.io.File
 ...
 */
class JoinsTest {
    private val fixturePackage = "ru/workinprogress/sborka/internal/fixture"
    ...
    fun `a suppression is read out of the source and counted`(
        ...
        assertEquals(
            listOf("ru.workinprogress.sborka.internal.fixture.JoinsFixtureSuppressed"),
            report.suppressed,
        )
    }
