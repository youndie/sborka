...
// substitute ordinary dependencies — and `sborka.lint` asks for one: `ru.workinprogress.sborka:kapkan`
...
// ru.workinprogress.sborka:kapkan:0.1.0". Which is the stand doing its job: the composite the root
